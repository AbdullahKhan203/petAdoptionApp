...
//     const filtered = allData.filter(item => item.breed.toLowerCase().includes(text.toLowerCase()));
//     setFilteredData(filtered);
//   };

//   const handleSearchButtonPress = () => {
//     // Call the filterData function with the current search text
...
//           }}
//           handleSearch={filterData}
//           onPress={handleSearchButtonPress} // Pass the handleSearchButtonPress function to the SearchComp component
//         />
//       </View>
//       {/* <Text>Email {userData.email} </Text>
//       <Text>Name {userData.userName} </Text>
